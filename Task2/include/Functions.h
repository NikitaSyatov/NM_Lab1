...
void RK4(double xstart, double y1start, double y2start, double stepstart,double Xmax, double a = 1.0, int maxSteps = 100, double tolerance = 0.001, double edge = 0.0)
{
    ...
    string SSS = "i\t\tx\t\tu(x)\t\tu^(x)\t\thi\t\tE\t\tC1\t\tC2",tab = "\t\t";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    while (a1.get_x() < Xmax && a1.get_iteration() < maxSteps)
    {
        ...
        else while (fabs(a05.get_y1() - a1.get_y1()) / (pow(2, p) - 1) > Epsilon && fabs(a05.get_y2() - a1.get_y2()) / (pow(2, p) - 1) > Epsilon)
        if (S1 > Epsilon)
        {
            a1 = tmp;
            a05 = a1;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        if (out1.is_open())
        {
            ...
            out1 << a1.get_iteration() << tab << a1.get_x() << tab << a1.get_y1() << tab << a05.get_y1() << tab << a1.get_h() << tab << localerase1 << tab << C11 << tab << C12 <<endl;
        ...
        if (out2.is_open())
        {
            out2 << a1.get_iteration() << tab << a1.get_x() << tab << a1.get_y2() << tab << a05.get_y2() << tab << a1.get_h() << tab << localerase2 << tab << C21 << tab << C22 << endl;
